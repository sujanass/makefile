...
volatile uint32_t error_cnt = 0;                           /*!< Used to Log Error Count at different functions */

/* This structure enables us to read from any mailbox */
typedef struct {                                           /*!< MAILBOX Structure      */
  volatile uint32_t       MAILBOX1_MSG;                    /*!< Mailbox1 message       */
  volatile uint32_t       MAILBOX2_MSG;                    /*!< Mailbox2 message       */
  volatile unsigned char  PRINT_MAILBOX_MSG [256];         /*!< Print mailbox message  */
  volatile uint32_t       MAILBOX1_FLG;                    /*!< Mailbox flag           */  
  volatile uint32_t       MAILBOX2_FLG;                    /*!< Mailbox flag           */  
} MAILBOX_Type;
...
typedef uint32_t MailboxFLAG;                              /*!< Mailbox flag           */
typedef uint32_t MailboxRAND;                              /*!< Mailbox random         */
typedef uint32_t MailboxREAD;                              /*!< Mailbox read           */
typedef uint32_t MailboxIRQ;                              /*!< Mailbox read           */
