...
check_data_types()
{
    ...
    if (sizeof(ee_u8) != 1)
    {
        z_printf("ERROR: ee_u8 is not an 8b datatype!\n");
        retval++;
    }
    if (sizeof(ee_u16) != 2)
    {
        z_printf("ERROR: ee_u16 is not a 16b datatype!\n");
        retval++;
    }
    if (sizeof(ee_s16) != 2)
    {
        z_printf("ERROR: ee_s16 is not a 16b datatype!\n");
        retval++;
    }
    if (sizeof(ee_s32) != 4)
    {
        z_printf("ERROR: ee_s32 is not a 32b datatype!\n");
        retval++;
    }
    if (sizeof(ee_u32) != 4)
    {
        z_printf("ERROR: ee_u32 is not a 32b datatype!\n");
        retval++;
    }
    ...
    if (retval > 0)
    {
        z_printf("ERROR: Please modify the datatypes in core_portme.h!\n");
    }
    return retval;
}
