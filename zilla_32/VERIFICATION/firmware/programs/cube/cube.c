...
int main()
{
    ...
    {
#ifdef SPIKE_RUN
                cube_SPIKE(op1_u,result_full,result_tb,testnumber);       
                PRINT_cube(op1_u,result_tb,result_full);
  
  
#else
              //random_array_cube(MAILBOX1, number,testnumber);

              //cube_C(MAILBOX1,number,testnumber,rev,prime_result);
            
            cube_C(MAILBOX1,op1_u,result_full,testnumber);
