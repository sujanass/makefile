...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
 * To find out the cuberoot of a number 
 */
...
#define DATA_SET        (5)   /*!< array of 10 elements      */
...
int main()
{
	...
	num_of_elements_memdump = (TEST_COUNT*5);

    #ifdef SPIKE_RUN
	printf("\nTest/> CUBEROOT NUMBER\n");
    printf("----------------------------------- \n");
     ...
     for(int testnumber = 1; testnumber <= TEST_COUNT; testnumber++)
  	{
#ifdef SPIKE_RUN
        CUBE_SPIKE(number,rslt_tb, rslt_full,testnumber);      
        PRINT_CUBE_SPIKE(number,rslt_tb,rslt_full,testnumber) 
#else
        CUBE_C(MAILBOX1,number,rslt_full, testnumber);
             //CUBE_C(MAILBOX1, number,testnumber);
