...
#define TEST_COUNT     (20)    /*!< Test count             */
...
//#include "ui_test.h"          /*!< Test macros            */
	...
	for(testnumber = 1; testnumber <= TEST_COUNT; testnumber++)
  	{
#ifdef SPIKE_RUN	
		MODULO_ARTHEMATIC_SPIKE(uint16_t,op1_16u,op2_16u,result_16u_full,result_16u_tb,testnumber);
        PRINT_RESULT_MODULO(op1_16u,op2_16u,result_16u_tb,result_16u_full,testnumber);
       //printf(" is %d \n received data is %s",final_data1,received_data);

#else
	    MODULO_ARTHEMATIC(MAILBOX1,uint16_t,op1_16u,op2_16u,result_16u_full,testnumber);
#endif
        testnumber++;
    }
