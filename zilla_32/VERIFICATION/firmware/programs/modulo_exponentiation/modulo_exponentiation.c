...
#define DATA_SET        (4)     /*!< op1, op2, op3,result       */
...
/* Array to store the operand1, operand2,operand3 and actual result */
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////Modulo Exponentiation  PART 1 ///////////////////////////////////////
#ifdef SPIKE_RUN
	printf("\nTest/> /Modulo Exponentiation tests:\n");
	printf("\n------------------------------\n");
#endif
...
////////////////////////  Reminder Test uint8_t ///////////////////////////////////////
	...
	for(testnumber = 1; testnumber <= TEST_COUNT; testnumber++)
  	{
#ifdef SPIKE_RUN	
		MODEXP1_TEST_U8_SPIKE_C(op1,op2,op3,result_full,result_tb,testnumber);
		MODEXP1_PRINT_RESULT_UU(x1,y1,p1,result_tb,result_full,testnumber);
#else
		MODEXP1_TEST_U8_C(MAILBOX1,op1,op2,op3,result_full,testnumber);
